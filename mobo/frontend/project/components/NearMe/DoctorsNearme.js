...
const DoctorsNearme = () => {
  ...
  const fetchNearbyHospitals = async (latitude, longitude) => {
    ...
    const apiUrl = `https://api.geoapify.com/v2/places?categories=healthcare&filter=rect:${boundingBox}&limit=10&apiKey=${GEOAPIFY_API_KEY}`;
